...
_(fE,cF)
_(oD,fE)
var hG=_mz(z,'navigator',['class',2,'href',1],[],e,s,gg)
...
var aL=_mz(z,'swiper',['autoplay',-1,'circular',-1,'indicatorDots',-1,'class',2,'duration',1,'indicatorActiveColor',2,'indicatorColor',3,'interval',4],[],e,s,gg)
var tM=_v()
_(aL,tM)
var eN=function(oP,bO,xQ,gg){
var fS=_n('swiper-item')
var cT=_mz(z,'image',['lazyLoad',-1,'class',11,'mode',1,'src',2],[],oP,bO,gg)
_(fS,cT)
_(xQ,fS)
return xQ
}
...
var x5=_mz(z,'navigator',['class',22,'href',1],[],t1,aZ,gg)
var o6=_oz(z,24,t1,aZ,gg)
_(x5,o6)
_(o4,x5)
_(e2,o4)
return e2
...
var tEB=_n('view')
_rz(z,tEB,'class',31,oBB,cAB,gg)
var eFB=_mz(z,'navigator',['class',32,'href',1],[],oBB,cAB,gg)
var bGB=_mz(z,'image',['src',34,'style',1],[],oBB,cAB,gg)
_(eFB,bGB)
_(tEB,eFB)
_(lCB,tEB)
return lCB
...
__wxAppCode__['pages/index/contract.wxss']=undefined;    
